...
DEBUG(DB_SYSCALL,"p : %p\n", p);
DEBUG(DB_SYSCALL,"curproc 1: %p\n", curproc);
...
DEBUG(DB_SYSCALL,"curproc 4: %p\n", curproc);
as_destroy(as);
DEBUG(DB_SYSCALL,"curproc 5: %p\n", curproc);
/* detach this thread from its process */
/* note: curproc cannot be used after this call */
proc_remthread(curthread);
DEBUG(DB_SYSCALL,"curproc 6: %p\n", curproc);
